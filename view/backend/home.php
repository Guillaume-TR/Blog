...
<div class="container">
    ...
    <div class="row">
        <article class="col-md-12 maincontent">
            ...
            <h2><a href="index.php?page=admin&action=episode">Gérez les épisodes</a></h2>
            ...
            <h2><a href="index.php?page=admin&action=account">Gérez les utilisateurs</a></h2>
            <blockquote>Gestion des utilisateurs du site. Ajouter un utilisateur, modifier un utilisateur ou supprimer un utilisateur.
            </blockquote>
            <h2><a href="index.php?page=admin&action=comment">Gérez les commentaires</a></h2>
