...
<form class="my-3" method="post" action="">
    <div class="input-group mt-3">
        ...
        <input type="text" class="form-control"aria-label="Username" name="username" aria-describedby="basic-addon1"<?php
		if (isset($_POST['username'])) {
			echo ' value="' . $_POST['username'] . '"';
		} ?>>
    </div>
    <small id="usernameHelp" class="form-text text-muted">Le nom d'utilisateur doit comporter au moin 5 caractères.</small>
    <div class="input-group mt-3">
        <div class="input-group-prepend">
